      ...
      <AccountProvider>
        <CartProvider>
          <div className="">
            ...
            <ToastContainer position={toast.POSITION.BOTTOM_LEFT} newestOnTop={true} className="max-h-[7%] md:max-h-[50%]" autoClose={1000} enableMultiContainer containerId={"cart"} />
            <Footer />
          </div>
        </CartProvider>
      </AccountProvider>
